...
repository.  It needs to include, in addition to the latest linstor
...
./scripts/create-iso.sh \
    ...
    --extra-packages "xcp-ng-release-linstor xcp-ng-linstor linstor-satellite-$LINSTOR82 linstor-controller-$LINSTOR82" \
    -V "XCP-NG_830_TEST" \
